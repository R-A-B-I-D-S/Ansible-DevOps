...
ok: [localhost] =>
  msg: |-
    СПИСОК A-ЗАПИСЕЙ ДЛЯ testbot.org

     1) my-project.testbot.org     → 192.16.1.1
     2) my-test.testbot.org        → 3.3.3.3
...
IP-адрес (например, 1.1.1.1): 5.5.5.5
...
TASK [✅ Отчёт] **********************************************************************************************************
ok: [localhost] =>
  msg: '✅ Создана: vpn-domen.testbot.org → 5.5.5.5'
...
ok: [localhost] =>
  msg: |-
    СПИСОК A-ЗАПИСЕЙ ДЛЯ testbot.org
     1) my-project.testbot.org     → 192.16.1.1
     2) my-test.testbot.org        → 3.3.3.3
     3) vpn-domen.testbot.org      → 5.5.5.5
```
...
Имя субдомена (например, demo или blog): my-test
IP-адрес для удаления (например, 1.1.1.1): 3.3.3.3
...
TASK [🧩 Найти A-запись с именем my-test и IP 3.3.3.3] *******************************************************************
...
ok: [localhost] =>
  msg: ' ✅ Успешно удалена my-test.testbot.org → 3.3.3.3 '
...
ok: [localhost] =>
  msg: |-
    СПИСОК A-ЗАПИСЕЙ ДЛЯ testbot.org
     1) my-project.testbot.org     → 192.16.1.1
     2) vpn-domen.testbot.org      → 5.5.5.5
```
